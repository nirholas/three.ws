...
import type { TxMetadata } from "../../src/wallet/types.js";
...
describe("transferSol", () => {
  it("converts amount to correct lamports (0.5 SOL → 500_000_000)", async () => {
    ...
    const [, , instructions, opts] = mockBuildAndSend.mock.calls[0];
  ...
  it("accepts to as a base58 string", async () => {
    ...
    await transferSol(wallet, connection, { to: recipientStr, amount: 1 });
