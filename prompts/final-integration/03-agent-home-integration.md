...
Both classes are complete. Your job is UX plumbing: mount them on `agent-home.html` such that a visiting user can (a) share the agent, and (b) the *owner* of the agent can deploy it on-chain without leaving the page.
