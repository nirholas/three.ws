...
```html
<!-- BEGIN:DISCOVER_LINK -->
<a href="/discover" id="discoverLink" class="discover-cta" hidden> Find my on-chain agents → </a>
<script type="module">
