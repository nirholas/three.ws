...
The agent is not just the avatar — name, description, and the skill list define what the agent _is_ and _does_. Users need a place to change these without opening a DB client.
