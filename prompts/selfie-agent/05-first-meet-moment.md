...
Repo: `/workspaces/3D`. After prompt 04, the user lands at `/create#step=meet`. Their agent exists, the GLB is registered, the slug is reserved. This is the one-time payoff — the first time they see _themselves_ in 3D, greeting them.
