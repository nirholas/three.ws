...
- **Action:** open an "Embed" modal with copy-to-clipboard for:
  - **iframe snippet** — `<iframe src="https://3dagent.vercel.app/agent/:id" width="400" height="600" frameborder="0"></iframe>`
  - **web component snippet** — `<agent-3d agent-id=":id"></agent-3d>` plus `<script src="https://3dagent.vercel.app/agent-3d.js"></script>`
...
### 3. Deploy on-chain
- **Label:** Deploy on-chain · *Optional*
- **Icon:** chain link
