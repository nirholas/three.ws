...
3. **From `/my-agents`**, when the user _has_ linked wallets but the result list is empty (no agents found), surface an inline message: "No agents found in your linked wallets yet. [Browse the community directory →](/discover)".
