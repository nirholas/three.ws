...
| VS Code Marketplace                                     | Brand-owned install surface           | Two finished extensions with builds, tests, icons, and listing copy               | Native developer discovery and activation                   | Resolve publisher identity; package and publish the 3D extension first           |
| Comfy Registry and Manager                              | Ecosystem-owned install surface       | Two working Forge nodes and a real smoke test                                     | Native creator discovery and one-click installation         | Add Registry metadata and publisher identity; package and publish                |
| Blender Extensions                                      | Foundation-owned install surface      | Working stdlib-only Forge add-on                                                  | Native 3D-creator discovery                                 | Honor Blender's online-access switch, add the manifest, package, and submit      |
