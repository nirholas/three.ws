...
export const githubUseCases = [
	repoUseCase({
		...
		description: 'Mint a coin for each newly trending GitHub repository. Creator fees route to the repo owner, who claims them by linking a Solana wallet on three.ws.',
