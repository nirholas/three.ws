...
The honest answer: you don't have to. The 3D Agent platform works without blockchain identity. But if you want your agent to exist beyond this platform, registration gives you things a database can't:
...
**Cross-platform composability.** Any EVM-compatible dApp, agent framework, or wallet can resolve your agent by its CAIP-10 ID without going through 3dagent.vercel.app. The `resolveOnchainAgent()` resolver is open source.
...
The 3D Agent app supports any injected EIP-1193 provider:
...
```
https://3dagent.vercel.app/a/<chainId>/<agentId>/embed
```
...
```json
{
  ...
  "services": [
    ...
    { "name": "3D", "endpoint": "https://3dagent.vercel.app/#model=ipfs://...", "version": "1.0" }
  ],
...
//   publicUrl: 'https://3dagent.vercel.app/a/8453/42',
...
| Resource | Path |
|----------|------|
| 3D Agent Card v1 spec | [/specs/3D_AGENT_CARD.md](../../specs/3D_AGENT_CARD.md) |
