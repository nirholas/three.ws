...
with no map. NVIDIA has [nvidia-visibility-map.md](./nvidia-visibility-map.md),
OpenAI has [openai-listing-channels.md](./openai-listing-channels.md), AWS has
[aws-marketplace-listing-kit.md](./aws-marketplace-listing-kit.md) and
[aws-builder-center.md](./aws-builder-center.md). The IBM docs in this folder are
...
[partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md) is the audit of the
...
Read [ibm.md](./ibm.md) before either. Its framing rules bind every item here,
...
finished post ([ibm-community-governed-agents-post.md](./ibm-community-governed-agents-post.md))
...
[partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md); they are repeated
...
| 4 | **A date for the second community event** | Same thread | [ibm-next-event.md](./ibm-next-event.md) is a finished proposal waiting on one decision. IBM said it is ready to host. |
...
| Supporting user groups and community | We run the Three.ws User Group on IBM Community: 4 blog posts, 8 discussion threads, 2 library entries at the 2026-08-13 snapshot ([ibm-community.md](./ibm-community.md)) |
| Creating articles, videos, and other spotlights | The IBM Community blog post recorded as Live in [listings.md](./listings.md), plus the group's tutorial threads |
| Providing product feedback to IBM development teams | Granite and watsonx.ai are wired into production surfaces documented in [ibm.md](./ibm.md); the feedback exists, it has never been routed to IBM as feedback |
...
| **Partner Plus Build track benefits** | Partner Plus portal | We sit in the Build track. Which benefits it carries, which are unclaimed, and which items in the monthly mailer are reachable at all are audited in [partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md). Not re-litigated here. |
...
Audited in full in [partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md):
...
that audit found is the same one the [NVIDIA map](./nvidia-visibility-map.md)
...
1. A date for the second community event, with [ibm-next-event.md](./ibm-next-event.md) attached as the run of show.
...
4. My Digital Marketing access and the Build track Partner Marketing Kit, with confirmation of our tier ([partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md) has the specifics to quote).
...
[partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md). Do not fold it in
...
- **Presenting the `/api/ibm/*` showcase as a partnership deliverable.** Not a
  ...
  outreach email. See the framing rules in [ibm.md](./ibm.md).
...
| Our user group's post cadence and last post | Read [ibm-community.md](./ibm-community.md) | Last catalogued post 2026-08-08; cadence allowance is one per week per [ibm.md](./ibm.md) |
| A finished group post is unposted | Read [ibm-community.md](./ibm-community.md) drafts table | [ibm-community-governed-agents-post.md](./ibm-community-governed-agents-post.md), written, not posted |
| The June co-marketing commitments are still open | Read [ibm.md](./ibm.md) and [partners/ibm-partner-plus.md](./partners/ibm-partner-plus.md) | The event was held; the IBM-domain page and the co-promotion have no recorded delivery |
...
- [IBM watsonx and Granite](./ibm.md): the integration, the partnership status, and the framing rules that bind everything here
