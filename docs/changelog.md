...
<script type="module" src="https://cdn.three.ws/agent-3d@1.5.1.js"></script>
...
```
https://cdn.three.ws/agent-3d@1.5.1/integrity.json
```
...
- **`versions.json`** — The CDN publishes a machine-readable index at `https://cdn.three.ws/agent-3d/versions.json` listing all available versions, channel aliases, and SRI hashes.
