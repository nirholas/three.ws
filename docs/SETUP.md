...
At minimum, `claude.ai` and `https://three.ws/` must be allowed origins for GET
...
- Authorization server metadata: `https://three.ws/.well-known/oauth-authorization-server`
- MCP endpoint: `POST https://three.ws/api/mcp` with
