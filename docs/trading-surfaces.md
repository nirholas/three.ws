...
- **Off-site** the same records travel: [the trader card](trader-card-embed.md) renders a trader's live record on any page with one script tag, and every coin on it forks back into the trade panel here.
