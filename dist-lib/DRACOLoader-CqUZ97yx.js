import { L as C, F as L, S as _, a as P, B as D, b as T, C as R, c as I } from "./lib-YDDmj7TG.js";
...
class x extends C {
  ...
  parse(e, o, s = () => {
    ...
    this.decodeDracoFile(e, o, null, null, _, s).catch(s);
  }
  //
  decodeDracoFile(e, o, s, r, n = P, t = () => {
  }) {
    const i = {
    ...
    return this.decodeGeometry(e, i).then(o).catch(t);
  }
  decodeGeometry(e, o) {
    ...
    const n = this.workerNextTaskID++, t = e.byteLength, i = this._getWorker(n, t).then((a) => (r = a, new Promise((h, d) => {
      r._callbacks[n] = { resolve: h, reject: d }, r.postMessage({ type: "decode", id: n, taskConfig: o, buffer: e }, [e]);
  ...
  _createGeometry(e) {
    const o = new D();
    e.index && o.setIndex(new T(e.index.array, 1));
    for (let s = 0; s < e.attributes.length; s++) {
      const r = e.attributes[s], n = r.name, t = r.array, i = r.itemSize, a = new T(t, i);
      n === "color" && (this._assignVertexColorSpace(a, r.vertexColorSpace), a.normalized = !(t instanceof Float32Array)), o.setAttribute(n, a);
    }
    return o;
  }
  _assignVertexColorSpace(e, o) {
    if (o !== _) return;
    const s = new R();
    for (let r = 0, n = e.count; r < n; r++)
      s.fromBufferAttribute(e, r), I.toWorkingColorSpace(s, _), e.setXYZ(r, s.r, s.g, s.b);
  }
  _loadLibrary(e, o) {
    const s = new L(this.manager);
    return s.setPath(this.decoderPath), s.setResponseType(o), s.setWithCredentials(this.withCredentials), new Promise((r, n) => {
      s.load(e, r, void 0, n);
    });
  }
  preload() {
  ...
  _initDecoder() {
    ...
    const e = typeof WebAssembly != "object" || this.decoderConfig.type === "js", o = [];
    return e ? o.push(this._loadLibrary("draco_decoder.js", "text")) : (o.push(this._loadLibrary("draco_wasm_wrapper.js", "text")), o.push(this._loadLibrary("draco_decoder.wasm", "arraybuffer"))), this.decoderPending = Promise.all(o).then((s) => {
      const r = s[0];
...
`);
  ...
  _getWorker(e, o) {
    return this._initDecoder().then(() => {
      ...
      return s._taskCosts[e] = o, s._taskLoad += o, s;
    });
  }
  _releaseTask(e, o) {
    e._taskLoad -= e._taskCosts[o], delete e._callbacks[o], delete e._taskCosts[o];
  }
  debug() {
...
function S() {
  ...
  onmessage = function(t) {
    ...
    switch (i.type) {
      case "init":
        k = i.decoderConfig, e = new Promise(function(d) {
          k.onModuleLoaded = function(u) {
            d({ draco: u });
      ...
      case "decode":
        ...
        e.then((d) => {
          ...
          try {
            const l = o(u, c, new Int8Array(a), h), f = l.attributes.map((y) => y.array.buffer);
  ...
  function o(t, i, a, h) {
    ...
    for (const p in d) {
      ...
      if (h.useUniqueIDs)
        ...
        if (b = i.GetAttributeId(c, t[d[p]]), b === -1) continue;
        g = i.GetAttribute(c, b);
      }
      const A = r(t, i, c, p, m, g);
      p === "color" && (A.vertexColorSpace = h.vertexColorSpace), y.attributes.push(A);
    }
    return f === t.TRIANGULAR_MESH && (y.index = s(t, i, c)), t.destroy(c), y;
  }
  function s(t, i, a) {
