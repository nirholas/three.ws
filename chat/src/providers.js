...
export const BUILTIN_MODELS = [
	{ id: 'google/gemini-2.0-flash-exp:free', name: 'Gemini 2.0 Flash', provider: 'Built-in', modality: 'text->text' },
	{ id: 'meta-llama/llama-3.3-70b-instruct:free', name: 'Llama 3.3 70B', provider: 'Built-in', modality: 'text->text' },
	{ id: 'deepseek/deepseek-r1:free', name: 'DeepSeek R1', provider: 'Built-in', modality: 'text->text' },
	{ id: 'qwen/qwen-2.5-72b-instruct:free', name: 'Qwen 2.5 72B', provider: 'Built-in', modality: 'text->text' },
	{ id: 'mistralai/mistral-7b-instruct:free', name: 'Mistral 7B', provider: 'Built-in', modality: 'text->text' },
];
