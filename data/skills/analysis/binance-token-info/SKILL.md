...
description: Query token details via Binance Web3 API by keyword, contract address, or chain. Search tokens, get metadata and social links, retrieve real-time market data (price, volume, holders, liquidity), and fetch K-Line candlestick charts.
license: MIT
metadata:
  category: analysis
  difficulty: beginner
  author: Binance
  tags: [binance, token, search, market-data, kline, candlestick, price]
---
