...
description: Subscribe and retrieve on-chain Smart Money trading signals via Binance Web3 API. Monitor buy/sell signals from professional investors including trigger price, current price, max gain, exit rate, and token tags across BSC and Solana.
license: MIT
metadata:
  category: trading
  difficulty: intermediate
  author: Binance
  tags: [binance, smart-money, signals, trading, whale, on-chain]
---
