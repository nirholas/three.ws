...
export type PumpAgentPayments = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "tokenAgentPayments" },
        {
          ...
          pda: {
            seeds: [
              { kind: "account"; path: "tokenAgentPayments" },
              {
                kind: "const";
              ...
              { kind: "account"; path: "currencyMint" },
            ];
            program: {
              kind: "const";
        ...
        },
        {
          ...
          pda: {
            seeds: [
              ...
              { kind: "account"; path: "tokenAgentPayments.mint"; account: "TokenAgentPayments" },
              { kind: "account"; path: "currencyMint" },
            ];
          };
        },
    ...
    },
    {
      ...
      accounts: [
        { name: "globalBuybackAuthority"; writable: true; signer: true },
        ...
        },
        {
          ...
          pda: {
            seeds: [
              { kind: "account"; path: "burnAuthority" },
        ...
        },
        {
          ...
          pda: {
            seeds: [
              { kind: "account"; path: "burnAuthority" },
              { kind: "account"; path: "tokenProgramCurrency" },
              { kind: "account"; path: "currencyMint" },
            ];
            program: {
              kind: "const";
      ...
      args: [{ name: "swapInstructionData"; type: "bytes" }];
    },
    {
      ...
      accounts: [
        ...
        { name: "currencyMint" },
        { name: "tokenAgentPayments"; writable: true },
        {
          name: "tokenAgentPaymentInCurrency";
          writable: true;
          pda: {
        ...
        },
        {
          ...
          pda: {
            seeds: [
              { kind: "account"; path: "buybackAuthority" },
              {
                kind: "const";
                value: [6,221,246,225,215,101,161,147,217,203,225,70,206,235,121,172,28,180,133,237,95,91,55,145,58,140,245,133,126,255,0,169];
              },
        ...
        },
        {
          ...
          pda: {
            seeds: [
              { kind: "account"; path: "withdrawAuthority" },
              {
                kind: "const";
                value: [6,221,246,225,215,101,161,147,217,203,225,70,206,235,121,172,28,180,133,237,95,91,55,145,58,140,245,133,126,255,0,169];
              },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "receiverAta"; writable: true },
        { name: "tokenProgram" },
        { name: "associatedTokenProgram"; address: "ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL" },
        { name: "systemProgram"; address: "11111111111111111111111111111111" },
        {
    ...
    },
    {
      ...
      args: [
        ...
        { name: "buybackAuthority"; type: "pubkey" },
      ];
    },
    {
    ...
    },
    {
      ...
      args: [
        { name: "protocolAuthority"; type: { option: "pubkey" } },
        { name: "buybackAuthority"; type: { option: "pubkey" } },
      ];
    },
  ];
  accounts: [
  ...
  errors: [
    { code: 6000; name: "UnauthorizedSigner"; msg: "The given account is not authorized to execute this instruction." },
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "tokenizedAgentMint"; type: "pubkey" },
          { name: "tokenAgentPayments"; type: "pubkey" },
          { name: "currencyMint"; type: "pubkey" },
          { name: "amount"; type: "u64" },
          { name: "memo"; type: "u64" },
          { name: "startTime"; type: "i64" },
          { name: "endTime"; type: "i64" },
          { name: "invoiceId"; type: "pubkey" },
          { name: "agentPostBalance"; type: "u64" },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "swapProgram"; type: "pubkey" },
          { name: "newTokensBoughtAndBurnedForCurrency"; type: "u64" },
          { name: "agentPostBalance"; type: "u64" },
          { name: "timestamp"; type: "i64" },
          { name: "currencyMintAmountForBuyback"; type: "u64" },
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "buybackBps"; type: "u16" },
          { name: "timestamp"; type: "i64" },
          { name: "tokenizedAgentSequence"; type: "u64" },
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "tokenAgentPayments"; type: "pubkey" },
          { name: "mint"; type: "pubkey" },
          { name: "oldBuybackBps"; type: "u16" },
          { name: "newBuybackBps"; type: "u16" },
          { name: "timestamp"; type: "i64" },
        ];
      };
    },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "protocolAuthority"; type: "pubkey" },
          { name: "buybackAuthority"; type: "pubkey" },
          { name: "supportedCurrenciesMint"; type: { array: ["pubkey", 10] } },
          { name: "tokenizedAgentSequence"; type: "u64" },
        ];
      };
    },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "mint"; type: "pubkey" },
          { name: "currencyMint"; type: "pubkey" },
          { name: "totalInvoicePaymentsMade"; type: "u64" },
          { name: "totalBuyback"; type: "u64" },
          { name: "totalWithdrawals"; type: "u64" },
          { name: "tokensBoughtBackAndBurned"; type: "u64" },
        ];
      };
    },
    {
